...
import 'package:kimantara/components/cart_manager.dart';
import 'package:kimantara/components/grid_shop.dart';
      ...
      new Stack(children: <Widget>[
        ...
        new Align(alignment: Alignment.bottomRight, child:
          new Container(margin: EdgeInsets.only(right: 10, bottom: 10),child:
            ...
            }, backgroundColor: Colors.black, child: new Icon(_showCart ? Icons.close : Icons.shopping_cart))
          )
        )
      ])
    );
